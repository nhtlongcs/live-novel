...
import warnings
from config import iargs, device
...
def do_run(args, model, diffusion):
    ...
    frame_prompt = args.prompts_series[0]
    ...
    for j, sample in enumerate(samples):
        ...
        with image_display:
            ...
            final_image_path = os.path.join(output_dir, output_filename)
